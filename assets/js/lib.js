...
if ("undefined" == typeof IMGROUP || !IMGROUP)
  var IMGROUP = {};
IMGROUP.namespace = function() {
  var I, n, e, f = arguments, r = null;
  for (I = 0; I < f.length; I += 1)
    for (e = ("" + f[I]).split("."),
           r = IMGROUP,
           n = "IMGROUP" == e[0] ? 1 : 0; n < e.length; n += 1)
      r[e[n]] = r[e[n]] || {},
        r = r[e[n]];
  return r
}
...
!function() {
  ...
  function t(e, n, r) {
    return ("string" == typeof n ? n : n.toString()).replace(e.define || i, function(t, n, o, a) {
      ...
      n in r || (":" === o ? (e.defineParams && a.replace(e.defineParams, function(e, t, o) {
        r[n] = {
          arg: t,
          text: o
        }
  ...
  o.template = function(r, u, c) {
    ...
    f = ("var out='" + (u.strip ? f.replace(/(^|\r|\n)\t* +| +\t*(\r|\n|$)/g, " ").replace(/\r|\n|\t|\/\*[\s\S]*?\*\//g, "") : f).replace(/'|\\/g, "\\$&").replace(u.interpolate || i, function(e, t) {
      ...
      return t ? (d += 1,
        p = o || "i" + d,
        t = n(t),
      "';var arr" + d + "=" + t + ";if(arr" + d + "){var " + r + "," + p + "=-1,l" + d + "=arr" + d + ".length-1;while(" + p + "<l" + d + "){" + r + "=arr" + d + "[" + p + "+=1];out+='") : "';} } out+='"
